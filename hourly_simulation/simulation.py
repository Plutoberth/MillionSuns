...
def get_usage_profile(future_demand: DemandDf, normalised_production: ProductionDf, params: Params,
    ...
    """
    solar_production = predict_solar_production(normalised_production, solar_panel_generation_kw, params)
    electricity_use: ElectricityUseDf = strategy(future_demand, solar_production,
...
def simulate_use(demand: DemandDf, normalised_production: ProductionDf, params: Params, solar_panel_power_kw: float,
    ...
    """
    predicted_demand = predict_demand(hourly_demand=demand, params=params,
                                           simulated_year=simulated_year)
    electricity_use = get_usage_profile(demand=predicted_demand, normalised_production=normalised_production,
